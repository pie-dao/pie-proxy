...
interface PProxyOverrideablePausableInterface extends Interface {
  functions: {
...
export class PProxyOverrideablePausable extends Contract {
  connect(
    signerOrProvider: Signer | Provider | string
  ): PProxyOverrideablePausable;
  attach(addressOrName: string): PProxyOverrideablePausable;
  deployed(): Promise<PProxyOverrideablePausable>;
  ...
  interface: PProxyOverrideablePausableInterface;
